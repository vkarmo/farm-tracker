                          ...
                          {fieldImagery[editingId || 'active'] && fieldImagery[editingId || 'active'] !== 'none' && (
                            <div style={{ marginTop: '8px', padding: '6px', background: '#f1f8e9', borderRadius: '4px', border: '1px solid #c5e1a5', fontSize: '0.72rem', color: '#33691e' }}>
                              <div style={{ fontWeight: 700, marginBottom: '2px' }}>
                                {fieldImagery[editingId || 'active'] === 'OWM_Clouds' ? 'Weather: Clouds' :
                                 fieldImagery[editingId || 'active'] === 'OWM_Precipitation' ? 'Weather: Precipitation' :
                                 fieldImagery[editingId || 'active'] === 'OWM_Temperature' ? 'Weather: Temperature' :
                                 fieldImagery[editingId || 'active'] === 'OWM_Wind' ? 'Weather: Wind Speed' :
                                 fieldImagery[editingId || 'active'] === 'OWM_Pressure' ? 'Weather: Sea Level Pressure' :
                              ...
                              {geeStatus[editingId || 'active'] && geeStatus[editingId || 'active'].status === 'failed' && (
                                <div style={{ marginTop: '4px', color: '#c62828', fontWeight: 600, fontSize: '0.65rem', lineHeight: '1.2' }}>
                                  {fieldImagery[editingId || 'active'].startsWith('OWM_') 
                                    ? `⚠ Weather Map Failed: ${geeStatus[editingId || 'active'].error}` 
                            ...
                            <div style={{ marginTop: '8px', display: 'flex', flexDirection: 'column', gap: '8px' }}>
                              ...
                              {fieldImagery[field.id] && fieldImagery[field.id] !== 'none' && (
                                <div style={{ padding: '6px', background: '#f1f8e9', borderRadius: '4px', border: '1px solid #c5e1a5', fontSize: '0.72rem', color: '#33691e', marginBottom: '8px' }}>
                                  <div style={{ fontWeight: 700, marginBottom: '2px' }}>
                                    {fieldImagery[field.id] === 'OWM_Clouds' ? 'Weather: Clouds' :
                                     fieldImagery[field.id] === 'OWM_Precipitation' ? 'Weather: Precipitation' :
                                     fieldImagery[field.id] === 'OWM_Temperature' ? 'Weather: Temperature' :
                                     fieldImagery[field.id] === 'OWM_Wind' ? 'Weather: Wind Speed' :
                                     fieldImagery[field.id] === 'OWM_Pressure' ? 'Weather: Sea Level Pressure' :
                                  ...
                                  {geeStatus[field.id] && geeStatus[field.id].status === 'failed' && (
                                    <div style={{ marginTop: '4px', color: '#c62828', fontWeight: 600, fontSize: '0.65rem', lineHeight: '1.2' }}>
                                      {fieldImagery[field.id].startsWith('OWM_') 
                                        ? `⚠ Weather Map Failed: ${geeStatus[field.id].error}` 
